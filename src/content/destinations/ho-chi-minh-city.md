...
essentials:
  - icon: "clock"
    ...
    value: "December-March (dry season)"
  - icon: "dollar"
    label: "Daily Budget"
    value: "$15-$180 depending on style"
  - icon: "thermometer"
    label: "Average Temperature"
    value: "25-35°C (77-95°F) year-round"
  - icon: "language"
    label: "Language"
    value: "Vietnamese (English widely spoken in tourist areas)"
  - icon: "plug"
    label: "Power"
    value: "220V, Types A, C, and F plugs"
  - icon: "water"
    label: "Tap Water"
    value: "Not safe to drink - bottled water everywhere"
  - icon: "sim"
    label: "SIM Card"
    value: "Available at airport for ~100,000 VND ($4)"
  - icon: "population"
    label: "Population"
    value: "Over 9 million (13 million metro)"
highlights:
  - "Dive into the chaos of Ben Thanh Market"
  - "Tour the harrowing Cu Chi Tunnels"
  - "Experience rooftop cocktails above the city skyline"
...
relatedDestinations:
  ...
  - "dalat"
faqItems:
  - question: "Should I call it Ho Chi Minh City or Saigon?"
    answer: "Locals use both, and no one will be offended either way. Officially it has been Ho Chi Minh City since 1976, but most residents still say Saigon in everyday conversation. The airport code is still SGN. I use both interchangeably and have never had an issue."
  - question: "Is Bui Vien (Backpacker Street) worth visiting?"
    answer: "At least once, yes. It is loud, chaotic, and unapologetically touristy, but it is also genuinely fun for a night out. Cheap beer (bia hoi) flows freely at around 10,000 VND ($0.40) a glass. I found that the side streets off Bui Vien had better food and a more relaxed vibe."
  - question: "How do I cross the street safely?"
    answer: "This is the number one question every visitor asks. The answer: walk slowly and steadily, do not stop or run, and let the motorbike river flow around you. Drivers are incredibly skilled at avoiding pedestrians - as long as you are predictable. It feels terrifying the first time and second nature by day three."
  - question: "Is the Cu Chi Tunnels tour worth it?"
...
affiliatePicks:
  ...
  - name: "Cu Chi Tunnels Small Group Tour"
    type: "tour"
    price: "$30-$50/person"
    personalNote: "I specifically booked a small group tour rather than the large bus tours, and the difference is night and day. Smaller groups get more time in the tunnels, better guides, and a less rushed experience."
    affiliateUrl: "https://www.viator.com/ho-chi-minh-city?pid=P00290009"
  - name: "Saigon Street Food Tour by Motorbike"
    type: "tour"
    price: "$30-$45/person"
    personalNote: "Riding pillion on a motorbike through Saigon's streets while stopping at hidden food stalls was the single most exhilarating food experience of my life. We hit about eight stops and I was stuffed by stop five."
    affiliateUrl: "https://www.getyourguide.com/ho-chi-minh-city?partner_id=IVN6IQ3"
  - name: "Mekong Delta Day Trip from HCMC"
    type: "tour"
    price: "$25-$40/person"
    personalNote: "If you cannot make it to Can Tho for an overnight, this day trip gives you a solid taste of the delta - floating markets, coconut candy workshops, sampan rides through narrow canals."
    affiliateUrl: "https://www.viator.com/ho-chi-minh-city?pid=P00290009"
...
Made famous by Anthony Bourdain, this stall serves a different noodle soup every day of the week. A bowl costs 50,000-70,000 VND ($2-$2.80). I returned on three different days and got three completely different soups. Each one was outstanding.

### Hu Tieu Nam Vang Thanh Xuan (Ton That Thiep, District 1)
Hu tieu is Saigon's answer to pho—a clear pork broth with rice noodles, shrimp, pork slices, and quail eggs. A bowl costs 55,000 VND ($2.20). I ordered the dry version (served with broth on the side) and the concentrated flavors were incredible.

## Where to Stay in Ho Chi Minh City

### Budget: The Common Room Project ($8-$15/night)
A beautifully designed hostel in District 1 with a social atmosphere and excellent coffee bar downstairs. Dorm beds from 200,000 VND ($8), private rooms from 500,000 VND ($20). The rooftop area is great for meeting other travelers.
...
**Getting Around:** Grab is your best friend. Rides are cheap—rarely more than 50,000 VND ($2) within the central districts. GrabBike (motorbike taxi) is even cheaper and faster through traffic. Walking is great in District 1 and 3 but exhausting in the heat. The metro Line 1 connects key areas.
