...
essentials:
  ...
  - icon: "dollar"
    label: "Daily Budget"
    value: "$25–$300+ depending on cruise"
  - icon: "thermometer"
    label: "Average Temperature"
    value: "15–32°C (59–90°F)"
  - icon: "unesco"
    label: "UNESCO Status"
    value: "World Heritage Site since 1994"
  - icon: "islands"
    label: "Karst Islands"
    value: "Nearly 2,000 limestone karsts"
  - icon: "water"
    label: "Water Activities"
    value: "Kayaking, swimming, cave tours"
  - icon: "cruise"
    label: "Best Experience"
    value: "Overnight cruise (1–3 nights)"
  - icon: "wildlife"
    label: "Marine Life"
    value: "Diverse coral reefs and fish species"
highlights:
  - "Wake up surrounded by 2,000 limestone karsts"
  - "Kayak through hidden lagoons and floating villages"
  - "Explore Sung Sot (Surprise) Cave"
  - "Swim in emerald waters beneath towering cliffs"
...
relatedDestinations:
  ...
  - "sapa"
faqItems:
  - question: "Should I do a day trip or overnight cruise?"
    answer: "Overnight, without question. A day trip covers only a small portion of the bay and you spend most of your time in transit. The overnight cruise lets you reach quieter areas, kayak at sunset, watch the stars from the deck, and wake up surrounded by karsts at dawn. It was one of the most magical mornings of my life."
  - question: "Which area is better—Ha Long Bay or Lan Ha Bay?"
    answer: "Lan Ha Bay, adjacent to Ha Long Bay but accessed from Cat Ba Island, is less crowded and equally beautiful. I preferred Lan Ha for its quieter waters and better kayaking. Many newer cruise operators offer combined itineraries that cover both. If you want the classic postcard views, Ha Long Bay proper delivers."
  - question: "How do I choose a cruise?"
    answer: "Read recent reviews obsessively—quality varies enormously. I look for: included kayaking, small group size (under 30 guests), meals cooked on board (not pre-packaged), and an itinerary that visits less-crowded areas. Budget cruises start around 1,500,000 VND ($60) per person; mid-range around 3,000,000 VND ($120); luxury from 5,000,000 VND ($200) up."
...
affiliatePicks:
  - name: "Indochina Junk 2-Day/1-Night Cruise"
    ...
    personalNote: "This was my mid-range cruise choice and it exceeded expectations. The wooden junk boat was beautifully maintained, the food was surprisingly excellent (fresh seafood cooked on board), and the kayaking excursion through a hidden lagoon was the highlight of my entire Vietnam trip."
    affiliateUrl: "https://www.getyourguide.com/ha-long-bay?partner_id=IVN6IQ3"
  - name: "Ha Long Bay Luxury Overnight Cruise"
    type: "tour"
    price: "$250–$400/person"
    personalNote: "If budget allows, the luxury cruises are worth the splurge. Private balconies, five-course dinners, tai chi on the deck at sunrise, and itineraries that reach the quietest corners of the bay. I upgraded for my second visit and the experience was transformative."
    affiliateUrl: "https://www.viator.com/ha-long-bay?pid=P00290009"
  - name: "Cat Ba Island & Lan Ha Bay Adventure"
    type: "tour"
    price: "$80–$150/person"
    personalNote: "For something more active, this Cat Ba-based tour combines hiking in Cat Ba National Park with kayaking in Lan Ha Bay. Less polished than the traditional cruises but more adventurous. I met some of my favorite travel friends on this trip."
    affiliateUrl: "https://www.getyourguide.com/ha-long-bay?partner_id=IVN6IQ3"
  - name: "Ha Long Bay Seaplane Flight"
    type: "activity"
    price: "$90–$150/person"
    personalNote: "Seeing the bay from above puts the scale into perspective in a way that no boat can. The 25-minute scenic flight covers thousands of karsts and the pilot dips low over floating villages. Expensive but unforgettable. Book well in advance as seats are limited."
    affiliateUrl: "https://www.viator.com/ha-long-bay?pid=P00290009"
