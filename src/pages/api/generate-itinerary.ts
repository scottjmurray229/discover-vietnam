...
function extractDestsFromText(text: string): string[] {
  ...
  const themeMap: Record<string, string[]> = {
    'beach': ['da-nang', 'nha-trang', 'phu-quoc'],
    'island': ['phu-quoc', 'ha-long-bay', 'nha-trang'],
    'snorkel': ['phu-quoc', 'nha-trang', 'da-nang'],
    'dive': ['phu-quoc', 'nha-trang', 'da-nang'],
    'diving': ['phu-quoc', 'nha-trang', 'da-nang'],
    'surf': ['da-nang', 'mui-ne'],
    'culture': ['hue', 'hoi-an', 'hanoi'],
    'history': ['hue', 'hanoi', 'ho-chi-minh-city'],
    'food': ['hanoi', 'hoi-an', 'ho-chi-minh-city'],
